...
<span class="atlas-badge">2D</span> <span class="atlas-badge">3D</span> <span class="atlas-badge">outdoor</span> <span class="atlas-badge">urban</span> <span class="atlas-badge">adverse weather</span>
...
- [Official dataset/project page](https://oxford-robotics-institute.github.io/radar-robotcar-dataset/)
- [Primary publication or project source](https://oxford-robotics-institute.github.io/radar-robotcar-dataset/)
- [Current terms or license source](https://oxford-robotics-institute.github.io/radar-robotcar-dataset/)
...
## Citation
Cite the original dataset publication and any provider-required references. This discovery-only record is not a substitute for the original citation instructions.

Recommended source: [https://oxford-robotics-institute.github.io/radar-robotcar-dataset/](https://oxford-robotics-institute.github.io/radar-robotcar-dataset/)

## Curator note
Discovery-only record. The atlas independently rewrote this summary and has not yet completed legal/access verification.
