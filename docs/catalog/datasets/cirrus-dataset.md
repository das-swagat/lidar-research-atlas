...
- non-uniform LiDAR research

## Authoritative sources

- [Official dataset/project page](https://developer.volvocars.com/open-datasets/cirrus/)
- [Primary publication or project source](https://developer.volvocars.com/open-datasets/cirrus/)
- [Current terms or license source](https://developer.volvocars.com/open-datasets/cirrus/)
...
Recommended source: [https://developer.volvocars.com/open-datasets/cirrus/](https://developer.volvocars.com/open-datasets/cirrus/)
