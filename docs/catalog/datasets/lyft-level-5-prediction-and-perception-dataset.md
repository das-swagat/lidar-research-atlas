# Lyft Level 5 Prediction and Perception Dataset
...
- [Official dataset/project page](https://level5.lyft.com/dataset/)
- [Primary publication or project source](https://level5.lyft.com/dataset/)
- [Current terms or license source](https://level5.lyft.com/dataset/)
...
Recommended source: [https://level5.lyft.com/dataset/](https://level5.lyft.com/dataset/)

## Curator note
Discovery-only record. The atlas independently rewrote this summary and has not yet completed legal/access verification. Provider availability and current access route require re-verification.
